...
proc update_PARAM_VALUE.MID { PARAM_VALUE.MID } {
	# Procedure called to update MID when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.MID { PARAM_VALUE.MID } {
	# Procedure called to validate MID
	return true
}
...
proc update_MODELPARAM_VALUE.MID { MODELPARAM_VALUE.MID PARAM_VALUE.MID } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.MID}] ${MODELPARAM_VALUE.MID}
}
