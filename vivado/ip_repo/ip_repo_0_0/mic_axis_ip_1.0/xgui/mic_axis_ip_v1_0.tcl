...
proc update_PARAM_VALUE.CLK_BITS { PARAM_VALUE.CLK_BITS } {
	# Procedure called to update CLK_BITS when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.CLK_BITS { PARAM_VALUE.CLK_BITS } {
	# Procedure called to validate CLK_BITS
	return true
}
...
proc update_PARAM_VALUE.NUM_CHUNK_BITS { PARAM_VALUE.NUM_CHUNK_BITS } {
	# Procedure called to update NUM_CHUNK_BITS when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.NUM_CHUNK_BITS { PARAM_VALUE.NUM_CHUNK_BITS } {
	# Procedure called to validate NUM_CHUNK_BITS
	return true
}

proc update_PARAM_VALUE.STRM_COUNT_BITS { PARAM_VALUE.STRM_COUNT_BITS } {
	# Procedure called to update STRM_COUNT_BITS when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.STRM_COUNT_BITS { PARAM_VALUE.STRM_COUNT_BITS } {
	# Procedure called to validate STRM_COUNT_BITS
	return true
}
...
proc update_MODELPARAM_VALUE.CLK_BITS { MODELPARAM_VALUE.CLK_BITS PARAM_VALUE.CLK_BITS } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.CLK_BITS}] ${MODELPARAM_VALUE.CLK_BITS}
}

proc update_MODELPARAM_VALUE.STRM_COUNT_BITS { MODELPARAM_VALUE.STRM_COUNT_BITS PARAM_VALUE.STRM_COUNT_BITS } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.STRM_COUNT_BITS}] ${MODELPARAM_VALUE.STRM_COUNT_BITS}
}

proc update_MODELPARAM_VALUE.NUM_CHUNK_BITS { MODELPARAM_VALUE.NUM_CHUNK_BITS PARAM_VALUE.NUM_CHUNK_BITS } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.NUM_CHUNK_BITS}] ${MODELPARAM_VALUE.NUM_CHUNK_BITS}
}
